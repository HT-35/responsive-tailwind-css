...
const App = () => {
  ...
  const imgHeight =
    halfHeight >= 250 ? Number(halfHeight - 100) : Number(halfHeight);
  const containerRef = useRef(null);

  useEffect(() => {
    const handleResize = () => {
      if (containerRef.current) {
        const widthFull = containerRef.current.clientWidth;

        const calculatedHalfHeight = widthFull / 2;
        setHalfHeight(calculatedHalfHeight);
      }
    };
  ...
  return (
    <div className="wrapper overflow-x-hidden  mx-auto 2xl:px-8  max-w-full ">
      <header className="w-full max-sm:px-4 xl:p-1 md:px-4 mx-auto ">
        <nav className="flex flex-row items-center justify-between max-sm:justify-center gap-2 ">
          <div className="max-sm:basis-3/5 relative text-xl max-sm:text-lg font-semibold text-center cursor-pointer logo basis-1/6">
            CoffeeStyle.
          </div>
          ...
          <div className="max-sm:basis-1/5  flex items-center justify-center gap-2 p-4 max-sm:p-2 text-sm font-medium text-center hover:cursor-pointer cart basis-1/6">
            <svg
          ...
          <div className="max-sm:basis-1/5  toggle menu-mobile hover:cursor-pointer sm:block md:block lg:block xl:hidden">
            <button
      ...
      <main className="   w-full max-sm:p-2 sm:p-2 md:p-2 xl:px-6 2xl:px-6  mx-auto ">
        <div
          className="relative h-[550px] w-full flex justify-center items-center
        ...
        >
          ...
          ></div>
          <div className="absolute grid gap-6 text-center text-white top-14 px-4">
        ...
        >
          <div className="video xl:basis-1/2 ">
            <video
              autoPlay
              loop
              muted
          ...
          <div className=" text-context xl:basis-1/2  xl:pr-10">
            <h1
              className="text-4xl xl:pr-10 mb-3  leading-10 text-left
              lg:text-4xl
             max-md:text-xl
             max-sm:text-base
            ...
            <h1
              className="mb-4 leading-7 text-left text-gray-500
            lg:text-lg
             max-md:text-base
             max-sm:text-sm
        ...
        >
          {halfHeight > 0 && (
            <div
              className={`FEATURED-MUGS h-[${halfHeight}px] w-full flex justify-center items-center gap-6`}
              style={{ height: `${imgHeight}px` }}
            >
              <div
                className="basis-1/2 w-full h-full bg-no-repeat bg-cover object-cover"
                style={{
                  backgroundImage:
                    "url('https://coffee-style-trungquandev.web.app/img/featured-mug-01.jpg')",
                }}
              ></div>
              <div
                className="basis-1/2 h-full bg-no-repeat bg-cover object-cover"
                style={{
                  backgroundImage:
                    "url('https://coffee-style-trungquandev.web.app/img/featured-mug-02.jpg')",
                }}
              ></div>
            </div>
          )}
        ...
        <ListProduct halfHeight={halfHeight}></ListProduct>
        ...
        <div className="w-full h-[350px] bg-[#1d1f2e] flex flex-col   justify-start items-center min-h-[300px]">
          ...
          >
            <input
              ...
              className=" px-5 py-7 bg-[#1d1f2e] font-semibold border-[1px] border-[#374151] w-[400px]
               h-[50px]
               max-md:h-[5px]
               max-md:py-4
               "
